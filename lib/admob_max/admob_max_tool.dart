...
class AdmobMaxTool {
  static final AdmobMaxTool instance = AdmobMaxTool();
  ...
  static Future<dynamic> initAdmobOrMax(
    ...
    List adsList = FireManager.adsFile[sceneType.value] ?? [];
    Map? adConfig;
    ...
    if (adConfig != null) {
      ...
      } else if (adConfig[FireConfigKey.sourceKey] ==
          AdsSourceType.max.value) {
    ...
    if (admobOrMaxAd == null) {
      ...
      if (nextLevelIndex < adsList.length) {
        ...
        AdmobMaxTool.instance.adRequestFail(sceneType);
    ...
    AppOpenAd.load(
      ...
      adLoadCallback: AppOpenAdLoadCallback(
        ...
        onAdLoaded: (ad) {
          ad.fullScreenContentCallback = FullScreenContentCallback(
            ...
            onAdFailedToShowFullScreenContent: (ad, err) {
              AdmobMaxTool.instance.showFailUpload(sceneType, err.message);
              ad.dispose();
              _noticeListeners(
                AdsState.dismissed,
                adsType: AdsType.open,
        ...
        onAdFailedToLoad: (LoadAdError error) {
          AdmobMaxTool.instance.msg = error.message;
          completer.complete();
        },
      ),
    );
      ...
      listener: NativeAdListener(
        ...
        onPaidEvent: (ad, valueMicros, precision, currencyCode) {
          BackEventManager.instance.addEvent(
            BackEventManager.instance.ad_event,
            BackEventManager.instance.ad_source,
            valueMicros,
            BackEventManager.instance.ad_linkId,
    ...
    AppLovinMAX.setAppOpenAdListener(
      AppOpenAdListener(
        ...
        onAdDisplayFailedCallback: (ad, error) {
          AdmobMaxTool.instance.showFailUpload(sceneType, error.message);
          _noticeListeners(
            AdsState.dismissed,
            adsType: AdsType.open,
            ad: ad,
  ...
  ///加载MAX的插屏广告
  static Future<MaxAd?> _requestMaxInterstitialAd(AdsSceneType sceneType) async {
    Completer<MaxAd?> completer = Completer<MaxAd?>();
  ...
  void nativeDismiss(
    ...
    AdmobMaxTool.initAdmobOrMax(currentScene);
  }
