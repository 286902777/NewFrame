...
class RenameAlertPage extends StatefulWidget {
  const RenameAlertPage({super.key, required this.model});
  final VideoModel model;

  @override
  State<RenameAlertPage> createState() => _RenameAlertPageState();
}

class _RenameAlertPageState extends State<RenameAlertPage> {
        ...
        child: CupertinoButton(
          ...
          onPressed: () {
            if (_controller.text.isNotEmpty) {
              var isEx = false;
              for (VideoModel m in AppDataBase.instance.items) {
              ...
              if (isEx) {
                ...
                AppDataBase.instance.updateVideoModel(widget.model);
                CusToast.show(message: "Rename successfully!");
                Get.back();
              }
            }
          },
