...
class FireConfigKey {
  ...
  static String maxKey = 'fasfasdfas';
  // app打开等待时长
...
class FireManager {
    ...
    updateRemoteSet() async {
      ...
      if (adsFile[FireConfigKey.playWaitKey] != null) {
        AdmobMaxTool.instance.playShowTime =
            adsFile[FireConfigKey.playWaitKey].toInt();
      }
      if (adsFile[FireConfigKey.adsTimeKey] != null) {
        AdmobMaxTool.instance.sameInterval =
            adsFile[FireConfigKey.adsTimeKey].toInt();
      }
      if (adsFile[FireConfigKey.nativeTimeKey] != null) {
        AdmobMaxTool.instance.nativeTime =
            adsFile[FireConfigKey.nativeTimeKey].toInt();
      }
      ...
      final AppsFlyerOptions afiOS = AppsFlyerOptions(
        afDevKey: kDebugMode ? 'safasdfa' : 'peWvF2B4ogJVqR9m4CgCXn',
        appId: kDebugMode ? '45482318' : '6751944433',
        showDebug: true,
  ...
  Future<void> getDeepDetails(String info) async {
    ...
    bool isfrist = await AppKey.getBool('getDeepLink') ?? false;
...
class DefaultOptions {
  ...
  static const FirebaseOptions ios = FirebaseOptions(
    apiKey: 'AIzaSyCKLJSOJIOO4Kbk',
    appId: '1:5135133:ios:sdfasdfas',
    projectId: 'test-sdfas-1123',
    iosBundleId: 'com.test.13123',
    storageBucket: 'test-asdfas-1aa.safasdfa.app',
    messagingSenderId: '795684684',
  );
}
